      ...
      <div className="flex items-center justify-between gap-10">
        ...
        <div className="flex items-center gap-5 flex-1">
          <img 
            src={dish.imageUrl} 
            alt={dish.name}
            className="w-20 h-20 rounded-full object-cover shadow-xl ring-2 ring-menu-gold/30"
          />
          <div className="flex-1">
            ...
            <button
              ...
              className="mt-3 px-4 py-1.5 bg-gradient-to-r from-menu-gold to-menu-gold/90 text-menu-green text-xs font-medium rounded-full flex items-center gap-2 w-fit shadow-md"
            >
        ...
        <div className="flex items-center justify-center w-28 h-28 rounded-full border-3 border-menu-gold bg-gradient-to-br from-menu-green/80 to-menu-green/60 shadow-xl shadow-menu-gold/20">
